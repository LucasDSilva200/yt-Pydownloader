...
def handling_of_arguments(args):
    if args['Video']:
        ...
        download_playlist(link=args['Videos'],
                          path_to_save=PATH_FOR_SAVE_FILE, itag=22)
    elif args['Musics']:
        download_playlist(link=args['Musics'],
                          path_to_save=PATH_FOR_SAVE_FILE, itag=140)
...
def main():
    ...
    group.add_argument('--showpath', help="Shows the way the files will be "
                       + "saved",
    ...
    group.add_argument('-Pv', '--Videos', type=str,
                       help="The link to the video playlist you want to "
                       + "download.")
    group.add_argument('-Pm', '--Musics', type=str,
                       help="The link to the Playlist of Songs you want to "
                       + "download.")
